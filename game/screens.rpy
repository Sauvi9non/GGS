...
style hyperlink_text is gui_text:
...
#screen navigation(): 메인메뉴에서 환경설정, 불러오기 눌렀을 때 이미지 버튼 사라지지 않는 현상 해결하기 위해 navigation screen 주석처리
#그리고 아래의 것들 다른 곳으로 옮겨준다. Screen Main Menu로
...
#        style "main_menu_frame"
    ...
    fixed:
        ...
        if main_menu:
            ...
            imagebutton auto "gui/mm_Start_%s.png" xpos 3 ypos 287 focus_mask True action Start() hovered
        ...
        imagebutton auto "gui/mm_Load_%s.png" xpos 19 ypos 349 focus_mask True action ShowMenu("load") hovered
        #textbutton _("엔딩목록") action ShowMenu("endingList") xpos 112 ypos 590
        if persistent.endingList_unlocked: #최초 게임 시작하기 전에는 엔딩목록 못 본다.
            imagebutton auto "gui/mm_endingList_%s.png" xpos 30 ypos 396 focus_mask True action ShowMenu("endingList") hovered
        #textbutton _("환경설정") action ShowMenu("preferences")
        imagebutton auto "gui/mm_Setting_%s.png" xpos 41 ypos 452 focus_mask True action ShowMenu("preferences") hovered
        #버전 정보
        imagebutton auto "gui/mm_versionInfo_%s.png" xpos 54 ypos 507 focus_mask True action ShowMenu("about") hovered
        #조작방법
        imagebutton auto "gui/mm_Control_%s.png" xpos 64 ypos 563 focus_mask True action ShowMenu("help") hovered
...
#           imagebutton auto "gui/mm_versionInfo_%s.png" xpos 54 ypos 507 focus_mask True action ShowMenu("about") hovered
    ...
    #       imagebutton auto "gui/mm_Control_%s.png" xpos 64 ypos 563 focus_mask True action ShowMenu("help") hovered
        ...
        if renpy.variant("pc"):
            ...
            imagebutton auto "gui/mm_Quit_%s.png" xpos 74 ypos 620 focus_mask True action Quit(confirm=not main_menu)
...
screen game_menu(title, scroll=None, yinitial=0.0):
    ...
    #use navigation <- 메인메뉴에서 환경설정같은거 들어갈 때 이미지 버튼 그대로 뜨는거 막기위해 Game Menu에서 이거 없앤다.
...
screen about():
    ...
    use game_menu(_("버전정보"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("이 게임에는 네이버에서 제공한 나눔글꼴이 적용되어 있습니다.\n"
            "Copyright (c) 2010, NAVER Corporation (https://www.navercorp.com/),\n\n"
            "with Reserved Font Name Nanum, Naver Nanum, NanumGothic, Naver NanumGothic, NanumMyeongjo, Naver NanumMyeongjo,\n"
            "NanumBrush, Naver NanumBrush, NanumPen, Naver NanumPen, Naver NanumGothicEco, NanumGothicEco, Naver NanumMyeongjoEco,\n"
            "NanumMyeongjoEco, Naver NanumGothicLight, NanumGothicLight, NanumBarunGothic, Naver NanumBarunGothic, NanumSquareRound, NanumBarunPen, MaruBuri\n"
            "This Font Software is licensed under the SIL Open Font License, Version 1.1.\n"
            "This license is copied below, and is also available with a FAQ at: http://scripts.sil.org/OFL\n\n"
            "SIL OPEN FONT LICENSE\n"
            "Version 1.1 - 26 February 2007\n\n\n")

            text _("이 게임에는 리디주식회사에서 제공한 리디바탕 글꼴이 사용되어 있습니다.\n"
            "This Font Software is licensed under the SIL Open Font License, Version 1.1.\n"
...
screen preferences():
    ...
    use game_menu(_("환경설정"), scroll="viewport"):
        ...
        hbox:
            ...
            null width (14 * gui.pref_spacing)
            ...
            vbox:
                ...
                textbutton _("타이틀로 돌아가기") action MainMenu()
            ...
            vbox:
                ...
                vbox:
                    ...
                    bar:
                        style "newBar" value Preference("text speed")

                    label _("자동 진행 시간")

                    bar:
                        style "newBar" value Preference("auto-forward time")
                    ...
                    if config.has_music:
                        ...
                        hbox:
                            bar:
                                style "newBar" value Preference("music volume")
                    ...
                    if config.has_sound:
                        ...
                        hbox:
                            bar:
                                style "newBar" value Preference("sound volume")
                    ...
                    if config.has_voice:
                        ...
                        hbox:
                            bar:
                                style "newBar" value Preference("voice volume")
